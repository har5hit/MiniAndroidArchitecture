 ...
 */
class UserRepository @Inject constructor(private val userDao: UserDao, private val executor: AppExecutors, private val userApi: UserApi, private val sharedPrefs: SharedPrefs) {
